...
('ai_impact_ready', 'AI Impact Analysis Ready (backfill re-engagement)', 'One-off email to assessment takers whose AI Career Impact section failed to generate due to a provider misconfiguration; sent once it was fixed and backfilled, inviting them to revisit their results.', true,
 'Your AI Career Impact Analysis Is Ready',
 'تحليل تأثير الذكاء الاصطناعي على مسارك المهني جاهز الآن',
'<br><span style="display: none; font-size: 0px; line-height: 0; max-height: 0px; opacity: 0; overflow: hidden;">Your personalized AI Career Impact analysis is ready — revisit your results.</span>
      ...
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; width: 100%; background: rgb(255, 255, 255); border-radius: 18px; overflow: hidden; box-shadow: rgba(0, 82, 204, 0.1) 0px 12px 40px; text-size-adjust: 100%;">
        ...
        <tbody><tr>
          <td bgcolor="#FFFFFF" style="background: rgb(255, 255, 255); padding: 38px 40px 30px; text-size-adjust: 100%;" align="center">
            ...
            <p style="margin: 0px; color: rgb(90, 106, 133); font-family: Arial, Helvetica, sans-serif; font-size: 10px;">by Etijah Coaching &amp; Consulting</p>
          </td>
        </tr>

        <tr>
          <td bgcolor="#0052CC" style="background: rgb(0, 82, 204); padding: 14px 40px; text-size-adjust: 100%;">
            <p style="margin: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 13px; font-weight: bold; letter-spacing: 1.5px; text-transform: uppercase; color: rgb(255, 255, 255);">Report update · AI Career Impact</p>
          </td>
        </tr>
        ...
        <tr><td style="padding: 0px 40px 30px; text-size-adjust: 100%;">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="text-size-adjust: 100%;"><tbody><tr>
            <td style="background: rgb(245, 249, 255); border-top: 3px solid rgb(0, 82, 204); border-radius: 14px; padding: 24px 24px 18px; text-size-adjust: 100%;">
              <p style="margin: 0px 0px 6px; font-family: Arial, Helvetica, sans-serif; font-size: 15px; font-weight: bold; color: rgb(0, 82, 204);">Need help?</p>
              <p style="margin: 0px 0px 16px; font-family: Arial, Helvetica, sans-serif; font-size: 13px; line-height: 1.9; color: rgb(90, 106, 133);">For any question or technical issue: reply to this email, or reach us on WhatsApp or by phone.</p>
        ...
        <tr>
          <td bgcolor="#00C9A7" style="background: rgb(0, 201, 167); padding: 26px 40px; text-size-adjust: 100%;" align="center">
            <p style="margin: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 12px; line-height: 1.6; color: rgb(255, 255, 255); font-weight: bold;">Etijah Coaching &amp; Consulting</p>
          </td>
        </tr>
...
'<br><span style="display: none; font-size: 0px; line-height: 0; max-height: 0px; opacity: 0; overflow: hidden;">تحليل تأثير الذكاء الاصطناعي على مسارك المهني جاهز الآن — راجع نتائجك.</span>
  ...
  <tbody><tr>
    <td align="center" style="padding: 24px 10px; text-size-adjust: 100%;">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; width: 100%; background: rgb(255, 255, 255); border-radius: 18px; overflow: hidden; box-shadow: rgba(0, 82, 204, 0.1) 0px 12px 40px; text-size-adjust: 100%;">
        ...
        <tbody><tr>
          <td bgcolor="#FFFFFF" style="background: rgb(255, 255, 255); padding: 38px 40px 30px; text-size-adjust: 100%;" align="center">
            <img src="https://erp.etijahcoaching.com/media/Etijahi/etijahi-logo-horizontal-single-icon.png" width="300" alt="اتجاهي" style="display: block; width: 300px; max-width: 78%; height: auto; margin: 0px auto 12px; border: 0px; outline: none; text-decoration: none;">
            <p style="margin: 0px; color: rgb(90, 106, 133); font-family: &quot;Segoe UI&quot;, Tahoma, Arial, sans-serif; font-size: 10px;">من اتجاه للإرشاد والاستشارات</p>
          </td>
        </tr>

        <tr>
          <td bgcolor="#0052CC" style="background: rgb(0, 82, 204); padding: 14px 40px; text-size-adjust: 100%;">
            <p dir="rtl" align="right" style="margin: 0px; font-family: &quot;Segoe UI&quot;, Tahoma, Arial, sans-serif; font-size: 15px; font-weight: bold; color: rgb(255, 255, 255);">تحديث على تقريرك · تأثير الذكاء الاصطناعي</p>
          </td>
        </tr>
        <tr><td style="height: 4px; background: rgb(0, 201, 167); font-size: 0px; line-height: 0; text-size-adjust: 100%;">&nbsp;</td></tr>
        ...
        <tr><td style="padding: 0px 40px 30px; text-size-adjust: 100%;">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="text-size-adjust: 100%;"><tbody><tr>
            <td style="background: rgb(245, 249, 255); border-top: 3px solid rgb(0, 82, 204); border-radius: 14px; padding: 24px 24px 18px; text-size-adjust: 100%;">
              <p dir="rtl" align="right" style="margin: 0px 0px 6px; font-family: &quot;Segoe UI&quot;, Tahoma, Arial, sans-serif; font-size: 15px; font-weight: bold; color: rgb(0, 82, 204);">هل تحتاج مساعدة؟</p>
              <p dir="rtl" align="right" style="margin: 0px 0px 16px; font-family: &quot;Segoe UI&quot;, Tahoma, Arial, sans-serif; font-size: 13px; line-height: 1.9; color: rgb(90, 106, 133);">لأي سؤال أو مشكلة تقنية: يكفي الرد على هذه الرسالة، أو تواصل معنا عبر واتساب أو الهاتف.</p>
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" dir="ltr" style="text-size-adjust: 100%;"><tbody><tr>
                <td width="50%" align="center" valign="top" style="padding: 0px 8px 0px 0px; text-size-adjust: 100%;">
                  <p style="margin: 0px 0px 4px; font-family: &quot;Segoe UI&quot;, Tahoma, Arial, sans-serif; font-size: 11px; font-weight: bold; letter-spacing: 1px; text-transform: uppercase; color: rgb(90, 106, 133);">السعودية</p>
                  <p style="margin: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; line-height: 2.1;"><a dir="ltr" href="https://wa.me/966550770711" style="color: rgb(0, 82, 204); text-decoration: none; font-weight: bold; white-space: nowrap;"><img src="https://erp.etijahcoaching.com/media/Etijahi/etijahi-icon-whatsapp.png" width="16" height="16" alt="WhatsApp" style="width: 16px; height: 16px; vertical-align: middle; margin: 0px 6px 3px 0px; border: 0px; outline: none; text-decoration: none;">+966 55 077 0711</a></p>
                </td>
                <td width="50%" align="center" valign="top" style="padding: 0px 0px 0px 8px; text-size-adjust: 100%;">
                  <p style="margin: 0px 0px 4px; font-family: &quot;Segoe UI&quot;, Tahoma, Arial, sans-serif; font-size: 11px; font-weight: bold; letter-spacing: 1px; text-transform: uppercase; color: rgb(90, 106, 133);">البحرين</p>
                  <p style="margin: 0px; font-family: Arial, Helvetica, sans-serif; font-size: 14px; line-height: 2.1;"><a dir="ltr" href="https://wa.me/97333462820" style="color: rgb(0, 82, 204); text-decoration: none; font-weight: bold; white-space: nowrap;"><img src="https://erp.etijahcoaching.com/media/Etijahi/etijahi-icon-whatsapp.png" width="16" height="16" alt="WhatsApp" style="width: 16px; height: 16px; vertical-align: middle; margin: 0px 6px 3px 0px; border: 0px; outline: none; text-decoration: none;">+973 3346 2820</a></p>
                </td>
              </tr></tbody></table>
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 16px; text-size-adjust: 100%;"><tbody><tr>
        ...
        <tr>
          <td bgcolor="#00C9A7" style="background: rgb(0, 201, 167); padding: 26px 40px; text-size-adjust: 100%;" align="center">
            <p style="margin: 0px; font-family: &quot;Segoe UI&quot;, Tahoma, Arial, sans-serif; font-size: 12px; line-height: 1.6; color: rgb(255, 255, 255); font-weight: bold;">اتجاه للإرشاد والاستشارات</p>
          </td>
        </tr>
